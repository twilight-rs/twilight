...
pub trait Cache {
    ...
    ) -> Result<Option<Self::Channel>, Self::Error>;
    ...
    async fn member(&self, guild_id: GuildId, user_id: UserId)
        -> Result<Self::Member, Self::Error>;
    ...
    async fn presence(
        ...
        user_id: UserId,
    ) -> Result<Self::Presence, Self::Error>;
    ...
    async fn voice_state(
        ...
        channel_id: ChannelId,
        user_id: UserId,
    ) -> Result<Self::VoiceState, Self::Error>;
