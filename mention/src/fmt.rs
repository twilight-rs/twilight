...
///
/// assert_eq!("<@123>", Id::<UserMarker>::new_checked(123).mention().to_string());
/// ```
...
///
/// let id = Id::<ChannelMarker>::new_checked(123);
...
mod tests {
    ...
    fn test_mention_format_channel_id() {
        assert_eq!(
            "<#123>",
            Id::<ChannelMarker>::new_checked(123).mention().to_string()
        );
    }
    ...
    fn test_mention_format_emoji_id() {
        assert_eq!(
            "<:emoji:123>",
            Id::<EmojiMarker>::new_checked(123).mention().to_string()
        );
    }
    ...
    fn test_mention_format_role_id() {
        assert_eq!(
            "<@&123>",
            Id::<RoleMarker>::new_checked(123).mention().to_string()
        );
    }
    ...
    fn test_mention_format_user_id() {
        assert_eq!(
            "<@123>",
            Id::<UserMarker>::new_checked(123).mention().to_string()
        );
    }
}
