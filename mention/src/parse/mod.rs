...
//! assert_eq!(Id::<EmojiMarker>::new_checked(123), Id::parse("<:name:123>")?);
//! assert_eq!(Id::<RoleMarker>::new_checked(456), Id::parse("<@&456>")?);
...
/// # fn main() -> Result<(), Box<dyn std::error::Error>> {
/// assert_eq!(
///     MentionType::Channel(Id::<ChannelMarker>::new_checked(123)),
///     MentionType::parse("<#123>")?,
/// );
/// assert_eq!(
///     MentionType::Role(Id::<RoleMarker>::new_checked(123)),
///     MentionType::parse("<@&123>")?,
/// );
/// assert_eq!(
///     MentionType::User(Id::<UserMarker>::new_checked(123)),
///     MentionType::parse("<@!123>")?,
/// );
///
