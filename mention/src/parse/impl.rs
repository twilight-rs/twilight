...
pub trait ParseMention: private::Sealed {
    ...
    /// assert_eq!(
    ///     Id::<ChannelMarker>::new_checked(123).expect("non zero"),
    ///     Id::parse("<#123>")?,
    /// );
    /// assert_eq!(
    ///     Id::<UserMarker>::new_checked(456).expect("non zero"),
    ///     Id::parse("<@456>")?,
    /// );
...
mod tests {
    ...
    fn test_parse_emoji_id() {
        assert_eq!(
            Id::<EmojiMarker>::new_checked(123).expect("non zero"),
    ...
    fn test_parse_mention_type() {
        assert_eq!(
            MentionType::Channel(Id::new_checked(123).expect("non zero")),
            MentionType::parse("<#123>").unwrap()
        );
        assert_eq!(
            MentionType::Emoji(Id::new_checked(123).expect("non zero")),
            MentionType::parse("<:name:123>").unwrap()
        );
        assert_eq!(
            MentionType::Role(Id::new_checked(123).expect("non zero")),
            MentionType::parse("<@&123>").unwrap()
        );
        assert_eq!(
            MentionType::User(Id::new_checked(123).expect("non zero")),
            MentionType::parse("<@123>").unwrap()
        );
        assert_eq!(
            &ParseMentionErrorType::Sigil {
    ...
    fn test_parse_role_id() {
        assert_eq!(
            Id::<RoleMarker>::new_checked(123).expect("non zero"),
            Id::parse("<@&123>").unwrap()
        );
        assert_eq!(
            &ParseMentionErrorType::Sigil {
    ...
    fn test_parse_user_id() {
        assert_eq!(
            Id::<UserMarker>::new_checked(123).expect("non zero"),
            Id::parse("<@123>").unwrap()
        );
        assert_eq!(
