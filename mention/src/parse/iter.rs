...
mod tests {
    ...
    fn test_iter_channel_id() {
        ...
        assert_eq!(Id::new_checked(123), iter.next().unwrap().0);
    ...
    fn test_iter_multiple_ids() {
        ...
        assert_eq!(Id::new_checked(789), mention);
        assert_eq!(19, start);
        assert_eq!(24, end);
        assert!(iter.next().is_none());
    }
    ...
    fn test_iter_emoji_ids() {
        ...
        assert_eq!(Id::new_checked(123), iter.next().unwrap().0);
        assert_eq!(Id::new_checked(456), iter.next().unwrap().0);
        assert!(iter.next().is_none());
    }
    ...
    fn test_iter_mention_type() {
        ...
        assert_eq!(
            MentionType::Channel(Id::new_checked(12)),
            iter.next().unwrap().0
        );
        assert_eq!(
            MentionType::Emoji(Id::new_checked(34)),
            iter.next().unwrap().0
        );
        assert_eq!(
            MentionType::Role(Id::new_checked(56)),
            iter.next().unwrap().0
        );
        assert_eq!(
            MentionType::User(Id::new_checked(78)),
            iter.next().unwrap().0
        );
        assert_eq!(
            MentionType::User(Id::new_checked(90)),
            iter.next().unwrap().0
        );
        assert!(iter.next().is_none());
    }
