...
use crate::{
    ...
    request::{
        ...
        guild::{
            ...
            role::{CreateRole, DeleteRole, GetGuildRoles, GetRole, UpdateRole, UpdateRolePositions},
            sticker::{
...
impl Client {
    ...
    /// Get a role of a guild by its id.
    pub const fn role(&self, guild_id: Id<GuildMarker>,
        role_id: Id<RoleMarker>,) -> GetRole<'_> {
