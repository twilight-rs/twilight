...
impl Standby {
    ...
    /// let standby = Standby::new();
    ///
    /// let guild_id = Id::new_checked(123);
    ///
    ...
    /// let standby = Standby::new();
    ///
    /// let author_id = Id::new_checked(456);
    /// let channel_id = Id::new_checked(123);
    ///
    ...
    /// let standby = Standby::new();
    ///
    /// let message_id = Id::new_checked(123);
    /// let user_id = Id::new_checked(456);
    ///
    ...
    ///     event.author_id() == Some(Id::new_checked(456))
    /// }).await?;
    /// # Ok(()) }
    /// ```
    ///
...
mod tests {
    ...
    fn message() -> Message {
        Message {
            ...
            channel_id: Id::new_checked(1),
            components: Vec::new(),
            content: "test".to_owned(),
            edited_timestamp: None,
            embeds: Vec::new(),
            flags: None,
            guild_id: Some(Id::new_checked(4)),
            interaction: None,
    ...
    async fn test_matched() {
        ...
        let standby = Standby::new();
        let guild_id_one = Id::new_checked(1);
        let guild_id_two = Id::new_checked(2);
    ...
    async fn test_wait_for_message() {
        ...
        let standby = Standby::new();
        let wait = standby
            .wait_for_message(Id::new_checked(1), |message: &MessageCreate| {
    ...
    async fn test_wait_for_message_stream() {
        ...
        let mut stream = standby
            .wait_for_message_stream(Id::new_checked(1), |_: &MessageCreate| true);
    ...
    async fn test_wait_for_reaction() {
        ...
        let standby = Standby::new();
        let wait = standby
            .wait_for_reaction(Id::new_checked(4), |reaction: &ReactionAdd| {
    ...
    async fn test_wait_for_reaction_stream() {
        let standby = Standby::new();
        let mut stream =
            standby.wait_for_reaction_stream(Id::new_checked(4), |_: &ReactionAdd| true);
    ...
    async fn test_wait_for_component() {
        ...
        let wait = standby.wait_for_component(
            ...
            |button: &MessageComponentInteraction| {
                button.author_id() == Some(Id::new_checked(2))
            },
        );
    ...
    async fn test_process_nonspecific_handling() {
        ...
        let wait = standby.wait_for(Id::new_checked(1), |event: &Event| {
