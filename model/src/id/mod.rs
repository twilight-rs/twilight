...
//! let guild_id = Id::<GuildMarker>::new_checked(123);
...
impl<T> Id<T> {
    ...
    /// Create a new non-zero ID while checking the value.
    ///
    ...
    /// use twilight_model::id::{marker::{GuildMarker, RoleMarker}, Id};
    ///
    /// let role_id: Id<RoleMarker> = Id::new_checked(1);
    ///
...
impl<T: Snowflake> Id<T> {
    ...
    /// };
    ///
    /// let id = Id::<UserMarker>::new_checked(105484726235607040);
    ///
...
mod tests {
    ...
    fn test_initializers() -> Result<(), Box<dyn Error>> {
        ...
        // `Id::new_checked`
        assert_eq!(1, Id::<GenericMarker>::new_checked(1).get());
    ...
    /// Test that creating a checked ID with a value of 0
    #[should_panic]
    #[test]
    const fn test_new_checked_zero() {
        let _ = Id::<GenericMarker>::new_checked(0);
    }

    /// Test that casting IDs maintains the original value.
    #[test]
    fn test_cast() {
        let id = Id::<GenericMarker>::new_checked(123);
    ...
    fn test_timestamp() {
        ...
        let id = Id::<GenericMarker>::new_checked(105_484_726_235_607_040);
    ...
    fn test_worker_id() {
        let expected: u8 = 8;
        let id = Id::<GenericMarker>::new_checked(762_022_344_856_174_632);
    ...
    fn test_process_id() {
        let expected: u8 = 1;
        let id = Id::<GenericMarker>::new_checked(61_189_081_970_774_016);
    ...
    #[test]
    fn test_debug() {
        let id = Id::<RoleMarker>::new_checked(114_941_315_417_899_012);
    ...
    #[test]
    fn test_display() {
        let id = Id::<GenericMarker>::new_checked(114_941_315_417_899_012);
    ...
    #[test]
    fn test_ordering() {
        let lesser = Id::<GenericMarker>::new_checked(911_638_235_594_244_096);
        let center = Id::<GenericMarker>::new_checked(911_638_263_322_800_208);
        let greater = Id::<GenericMarker>::new_checked(911_638_287_939_166_208);
    ...
    fn test_serde() {
        serde_test::assert_tokens(
            &Id::<ApplicationMarker>::new_checked(114_941_315_417_899_012),
            &[
        ...
        serde_test::assert_tokens(
            &Id::<AttachmentMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<AuditLogEntryMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<ChannelMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<CommandMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<CommandVersionMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<EmojiMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<GenericMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<GuildMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<IntegrationMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<InteractionMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<MessageMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<RoleMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<StageMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<UserMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
        ...
        serde_test::assert_tokens(
            &Id::<WebhookMarker>::new_checked(114_941_315_417_899_012),
            &[
                Token::NewtypeStruct { name: "Id" },
                Token::Str("114941315417899012"),
            ],
