...
mod tests {
    ...
    fn test_full() {
        let value = StickerPack {
            banner_asset_id: Some(Id::new_checked(761_773_777_976_819_732)),
            cover_sticker_id: Some(Id::new_checked(749_053_689_419_006_003)),
            description: "Say hello to Wumpus!".into(),
            id: Id::new_checked(847_199_849_233_514_549),
            name: "Wumpus Beyond".into(),
            sku_id: Id::new_checked(847_199_849_233_514_547),
            stickers: Vec::from([Sticker {
                available: true,
                description: Some("Wumpus waves hello".into()),
                format_type: StickerFormatType::Lottie,
                guild_id: None,
                id: Id::new_checked(749_054_660_769_218_631),
                kind: StickerType::Standard,
                name: "Wave".into(),
                pack_id: Some(Id::new_checked(847_199_849_233_514_549)),
                sort_value: Some(12),
