...
mod tests {
    ...
    fn test_news_thread() -> Result<(), TimestampParseError> {
        ...
        let value = NewsThread {
            ...
            last_message_id: Some(Id::new_checked(5)),
            member: Some(ThreadMember {
                flags: 12,
                id: Some(Id::new_checked(10)),
                join_timestamp: timestamp,
                member: None,
                presence: None,
                user_id: Some(Id::new_checked(11)),
            }),
            member_count: 7,
            message_count: 6,
            name: "test".to_owned(),
            owner_id: Some(Id::new_checked(3)),
            parent_id: Some(Id::new_checked(4)),
