...
mod tests {
    ...
    fn test_news_thread() -> Result<(), TimestampParseError> {
        ...
        let value = NewsThread {
            ...
            last_message_id: Some(Id::new(5).expect("non zero")),
            member: Some(ThreadMember {
                flags: 12,
                id: Some(Id::new(10).expect("non zero")),
                join_timestamp: timestamp,
                member: None,
                presence: None,
                user_id: Some(Id::new(11).expect("non zero")),
            }),
            member_count: 7,
            message_count: 6,
            name: "test".to_owned(),
            owner_id: Some(Id::new(3).expect("non zero")),
