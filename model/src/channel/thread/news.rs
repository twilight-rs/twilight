...
mod tests {
    ...
    #[test]
    fn test_news_thread() -> Result<(), TimestampParseError> {
        ...
        let value = NewsThread {
            ...
            last_message_id: Some(Id::new_checked(5).expect("non zero")),
            member: Some(ThreadMember {
                flags: 12,
                id: Some(Id::new_checked(10).expect("non zero")),
                join_timestamp: timestamp,
                member: None,
                presence: None,
                user_id: Some(Id::new_checked(11).expect("non zero")),
            }),
            member_count: 7,
            message_count: 6,
            name: "test".to_owned(),
            owner_id: Some(Id::new_checked(3).expect("non zero")),
            parent_id: Some(Id::new_checked(4).expect("non zero")),
