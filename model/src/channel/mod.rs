...
mod tests {
    ...
    fn guild_category() -> CategoryChannel {
        CategoryChannel {
            guild_id: Some(Id::new_checked(321)),
            id: Id::new_checked(123),
    ...
    fn test_channel_helpers() {
        assert_eq!(Channel::Group(group()).id(), Id::new_checked(123));
        assert_eq!(
        ...
        assert_eq!(Channel::Private(private()).id(), Id::new_checked(234));
    }
    ...
    fn test_guild_channel_id() {
        ...
        assert_eq!(GuildChannel::Text(guild_text()).id(), Id::new_checked(456));
        assert_eq!(
    ...
    fn test_guild_channel_unknown_field_deserialization() {
        ...
        let value = GuildChannel::Text(TextChannel {
            ...
            id: Id::new_checked(2),
            kind: ChannelType::GuildText,
            last_message_id: Some(Id::new_checked(3)),
            last_pin_timestamp: None,
            name: "hey".to_owned(),
            nsfw: false,
            parent_id: None,
    ...
    fn test_guild_news_channel_deserialization() {
        let value = GuildChannel::Text(TextChannel {
            ...
            last_message_id: Some(Id::new_checked(4)),
            last_pin_timestamp: None,
            name: "news".to_owned(),
            nsfw: true,
            permission_overwrites: Vec::new(),
            parent_id: Some(Id::new_checked(5)),
            position: 3,
            rate_limit_per_user: None,
    ...
    fn test_guild_news_thread_deserialization() {
        ...
        let value = GuildChannel::NewsThread(NewsThread {
            ...
            member: Some(ThreadMember {
                flags: 0_u64,
                id: Some(Id::new_checked(4)),
                join_timestamp: timestamp,
                member: None,
                presence: None,
                user_id: Some(Id::new_checked(5)),
            }),
            member_count: 50_u8,
            message_count: 50_u8,
            name: "newsthread".into(),
            owner_id: Some(Id::new_checked(5)),
            parent_id: Some(Id::new_checked(2)),
    ...
    fn test_guild_private_thread_deserialization() {
        ...
        let value = GuildChannel::PrivateThread(PrivateThread {
            ...
            permission_overwrites: Vec::from([PermissionOverwrite {
                ...
                kind: PermissionOverwriteType::Member(Id::new_checked(5)),
            }]),
            rate_limit_per_user: Some(1000_u64),
            thread_metadata: ThreadMetadata {
                archived: false,
