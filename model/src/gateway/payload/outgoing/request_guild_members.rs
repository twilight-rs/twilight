...
impl RequestGuildMembersBuilder {
    ...
    ///
    /// let request = RequestGuildMembers::builder(Id::new_checked(1))
    ///     .presences(true)
    ///     .query("a", None);
    ///
    /// assert_eq!(Id::new_checked(1), request.d.guild_id);
    ...
    /// let request = RequestGuildMembers::builder(Id::new_checked(1))
    ///     .nonce("test")
    ///     .user_id(Id::new_checked(2));
    ///
    /// assert_eq!(Some(RequestGuildMemberId::One(Id::new_checked(2))), request.d.user_ids);
    /// ```
    ...
    /// let request = RequestGuildMembers::builder(Id::new_checked(1))
    ///     .nonce("test")
    ///     .user_ids(vec![Id::new_checked(2), Id::new_checked(2)])?;
    ///
