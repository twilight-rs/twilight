        ...
        loop {
            ...
            match key {
                ...
                Field::Members => {
                    ...
                    let deserializer = MemberListDeserializer::new(Id::new_checked(1));
                ...
                Field::Presences => {
                    ...
                    let deserializer = PresenceListDeserializer::new(Id::new_checked(1));
        ...
        let expected = MemberChunk {
            ...
            members: Vec::from([
                Member {
                    ...
                    pending: false,
                    premium_since: None,
                    roles: vec![Id::new_checked(6), Id::new_checked(7)],
                    user: User {
                        id: Id::new_checked(2),
                        accent_color: None,
