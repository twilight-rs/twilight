...
mod tests {
    ...
    fn test_voice_state_update() {
        ...
        let value = VoiceStateUpdate(VoiceState {
            ...
            member: Some(Member {
                ...
                pending: false,
                premium_since: None,
                roles: vec![Id::new_checked(4).expect("non zero")],
                user: User {
    ...
    fn voice_state_update_deser_tokens() -> Result<(), TimestampParseError> {
        ...
        let value = VoiceStateUpdate(VoiceState {
            channel_id: None,
            deaf: false,
            guild_id: Some(Id::new_checked(999_999).expect("non zero")),
            member: Some(Member {
                avatar: None,
                communication_disabled_until: None,
                deaf: false,
                guild_id: Id::new_checked(999_999).expect("non zero"),
                joined_at,
                mute: false,
                ...
                roles: vec![
                    ...
                    Id::new_checked(124).expect("non zero"),
                ],
                user: User {
                    id: Id::new_checked(1_234_123_123_123).expect("non zero"),
                    accent_color: None,
            ...
            suppress: false,
            token: None,
            user_id: Id::new_checked(123_213).expect("non zero"),
