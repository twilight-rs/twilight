            ...
            serialized_source_guild: TemplateGuild {
                ...
                channels: vec![
                    ...
                    GuildChannel::Text(TextChannel {
                        ...
                        name: "general".into(),
                        nsfw: false,
                        parent_id: Some(Id::new_checked(1)),
                        permission_overwrites: vec![
                            PermissionOverwrite {
                            ...
                            PermissionOverwrite {
                                ...
                                kind: PermissionOverwriteType::Role(Id::new_checked(2)),
                            },
                        ],
                        position: 0,
                    ...
                    GuildChannel::Voice(VoiceChannel {
                        ...
                        name: "General".into(),
                        parent_id: Some(Id::new_checked(3)),
                        permission_overwrites: vec![],
                        rtc_region: None,
                        position: 0,
                        user_limit: Some(0),
                ...
                system_channel_id: Some(Id::new_checked(2)),
                verification_level: VerificationLevel::None,
            },
            source_guild_id: Id::new_checked(200),
            updated_at,
            usage_count: 0,
        };
