...
mod test {
    ...
    fn test_interaction_full() -> Result<(), TimestampParseError> {
        ...
        let value = Interaction::ApplicationCommand(Box::new(ApplicationCommand {
            application_id: Id::new_checked(100),
            channel_id: Id::new_checked(200),
            data: CommandData {
                ...
                options: Vec::from([CommandDataOption {
                    focused: false,
                    name: "member".into(),
                    value: CommandOptionValue::User(Id::new_checked(600)),
                }]),
            ...
            guild_id: Some(Id::new_checked(400)),
            id: Id::new_checked(500),
