...
mod test {
    ...
    fn test_interaction_full() -> Result<(), TimestampParseError> {
        ...
        let value = Interaction::ApplicationCommand(Box::new(ApplicationCommand {
            application_id: Id::new_checked(100).expect("non zero"),
            channel_id: Id::new_checked(200).expect("non zero"),
            data: CommandData {
                id: Id::new_checked(300).expect("non zero"),
                name: "command name".into(),
                options: Vec::from([CommandDataOption {
                    focused: false,
                    name: "member".into(),
                    value: CommandOptionValue::User(Id::new_checked(600).expect("non zero")),
                }]),
                resolved: Some(CommandInteractionDataResolved {
                    channels: HashMap::new(),
                    members: IntoIterator::into_iter([(
                        Id::new_checked(600).expect("non zero"),
                        InteractionMember {
                            avatar: None,
                    ...
                    users: IntoIterator::into_iter([(
                        ...
                        User {
                            ...
                            email: None,
                            flags: None,
                            id: Id::new_checked(600).expect("non zero"),
                            locale: None,
                            mfa_enabled: None,
                            name: "username".into(),
                            premium_type: None,
            ...
            guild_id: Some(Id::new_checked(400).expect("non zero")),
            id: Id::new_checked(500).expect("non zero"),
